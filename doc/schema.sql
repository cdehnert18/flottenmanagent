...
-- 1 +/- SELECT COUNT(*) FROM PUBLIC.FLEET_USER;               
INSERT INTO "PUBLIC"."FLEET_USER" VALUES
(1, 1, 'Benutzer 1 aktualisiert');    
...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.MISSION;  
...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.MISSION_EXECUTION;        
...
-- 1 +/- SELECT COUNT(*) FROM PUBLIC.POSITION; 
...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.ROUTE_EXECUTION;          
...
-- 1 +/- SELECT COUNT(*) FROM PUBLIC.TENANT;   
...
-- 1 +/- SELECT COUNT(*) FROM PUBLIC.UGV;      
INSERT INTO "PUBLIC"."UGV" VALUES
(100.0, 10.0, 1, NULL, 'Speedster');         
